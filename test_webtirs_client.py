...
def api_response_with_missing_data():
    ...
    return {
        "Header": {"row_count": 3, "start_date": "20102025", "end_date": "20102025"},
        "Rows": [
            {
                "Site Name": "Example Site",
...
def invalid_observations_api_response():
    ...
    return {
        "Header": {"row_count": 1, "start_date": "20102025", "end_date": "20102025"},
        # missing 'Rows' key
    }
...
def api_response_single_record():
    ...
    return {
        "Header": {"row_count": 1, "start_date": "21102025", "end_date": "21102025"},
        "Rows": [
            {
                "Site Name": "Example Site",
...
def api_response_empty():
    ...
    return {
        "Header": {"row_count": 0, "start_date": "22102025", "end_date": "22102025"},
        "Rows": [],
    }
...
class TestSingleSite:
    ...
    def test_calculate_avg_speed_for_hour(self, populated_site):
        ...
        assert populated_site.calculate_avg_speed_for_hour(hour=2) is None
    ...
    def test_calculate_avg_speed_for_hour_no_valid(
        self, populated_site_no_speed_or_volume
    ):
    ...
    def test_calculate_total_volume_for_hour_no_valid(
        self, populated_site_no_speed_or_volume
    ):
...
class TestObservation:
    ...
    def test_comparison_different_dates(self, sample_observations_diff_dates):
        ...
        assert not (
            sample_observations_diff_dates[1] < sample_observations_diff_dates[0]
        )
